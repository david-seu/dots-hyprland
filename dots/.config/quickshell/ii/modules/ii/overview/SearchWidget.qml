        ...
        ColumnLayout {
            ...
            ListView { // App results
                ...
                delegate: SearchItem {
                    ...
                    entry: modelData
                    query: StringUtils.cleanOnePrefix(root.searchingText, [Config.options.search.prefix.action, Config.options.search.prefix.app, Config.options.search.prefix.clipboard, Config.options.search.prefix.math, Config.options.search.prefix.shellCommand])
